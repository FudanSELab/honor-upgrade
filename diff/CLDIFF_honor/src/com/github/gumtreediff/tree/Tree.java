...
public class Tree extends AbstractTree implements ITree {
    ...
    private int prevOrCurr;
    private Integer[] lineRange;

    // add by yxy
    public Tree(int type, String label, Object astNode) {
        this.type = type;
        ...
        this.node = astNode;
        this.astClass = astNode.getClass();
    }


    public Tree(int type, String label, Object astNode, Integer[] lineRange) {
        this.type = type;
        this.label = (label == null) ? NO_LABEL : label.intern();
        this.id = NO_ID;
        this.depth = NO_VALUE;
    ...
    private Tree(Tree other) {
        ...
        this.astClass = other.getClass();
    }

    public void setTreePrevOrCurr(int a){
        this.prevOrCurr = a;
    }
    ...
    public void insertChild(ITree t, int position) {
    	//TODO buggy code
        Global.logger.info(children.size() + ":" + position);
    ...
    public int getTreePrevOrCurr(){
        return this.prevOrCurr;
    }

    @Override
    public String toString() {
        String c = this.getNode().getClass().getSimpleName();
        if (this.doActions != null) {
            for (Action a : this.doActions) {
