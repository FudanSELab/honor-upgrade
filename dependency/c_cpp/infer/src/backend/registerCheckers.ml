...
let all_checkers =
  ...
  ; { checker= DependencyAnalysis
    ; callbacks=
        [(interprocedural Payloads.Fields.dependency_analyze Nasus.DependencyAnalysis.checker, Clang);
        (interprocedural Payloads.Fields.dependency_analyze Nasus.DependencyAnalysis.checker, Java)] }
  ]
