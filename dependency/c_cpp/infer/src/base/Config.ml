...
and test_dependency =
  CLOpt.mk_bool
    ~deprecated:["test_dependency"; "-test_dependency"; "td"]
    ~deprecated_no:["ntd"] ~long:"test-dependency" "Testing for dependency analysis"
...
and test_dependency = !test_dependency
